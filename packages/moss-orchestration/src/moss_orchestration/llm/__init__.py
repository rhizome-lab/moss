...
Example:
    from moss_orchestration.llm import get_provider, complete
...
from moss_orchestration.llm.protocol import LLMProvider, LLMResponse, Message, Role
...
def _register_builtin_providers() -> None:
    ...
    from moss_orchestration.llm.providers.cli import CLIProvider

    register_provider("cli", CLIProvider)

    # LiteLLM
    try:
        from moss_orchestration.llm.providers.litellm import LiteLLMProvider
    ...
    try:
        from moss_orchestration.llm.providers.llm_lib import LLMLibProvider
    ...
    # Bifrost
    try:
        from moss_orchestration.llm.providers.bifrost import BifrostProvider
    ...
    # llama.cpp
    try:
        from moss_orchestration.llm.providers.llamacpp import LlamaCppProvider
    ...
    # KoboldAI/KoboldCpp
    try:
        from moss_orchestration.llm.providers.kobold import KoboldProvider
    ...
    # ExLlamaV2
    try:
        from moss_orchestration.llm.providers.exllama import ExLlamaProvider
