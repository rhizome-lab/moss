...
class PluginRegistry:
    ...
    def register_builtins(self) -> None:
        ...
        try:
            from moss_orchestration.plugins.tree_sitter import TreeSitterSkeletonPlugin
        ...
        from moss_orchestration.plugins.data_files import JSONSchemaPlugin, TOMLSchemaPlugin, YAMLSchemaPlugin
