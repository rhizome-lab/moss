...
fn cmd_trace(
    ...
    let mut signature_map: std::collections::HashMap<String, (String, usize)> =
        std::collections::HashMap::new();
    fn collect_signatures(
        sym: &moss_languages::Symbol,
        map: &mut std::collections::HashMap<String, (String, usize)>,
    ) {
...
fn trace_assignments(
    ...
    end_line: usize,
    max_depth: usize,
    signature_map: &std::collections::HashMap<String, (String, usize)>,
) -> Vec<TraceEntry> {
