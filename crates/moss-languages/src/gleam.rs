...
impl Language for Gleam {
    fn name(&self) -> &'static str { "Gleam" }
    fn extensions(&self) -> &'static [&'static str] { &["gleam"] }
    fn grammar_name(&self) -> &'static str { "gleam" }
    ...
    fn module_name_to_paths(&self, module: &str) -> Vec<String> {
        ...
        vec![
            format!("{}.gleam", path),
            format!("src/{}.gleam", path),
        ]
    }

    fn lang_key(&self) -> &'static str { "gleam" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["gleam"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".gleam").unwrap_or(entry_name).to_string()
    }
