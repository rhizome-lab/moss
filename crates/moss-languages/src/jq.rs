...
impl Language for Jq {
    ...
    fn extensions(&self) -> &'static [&'static str] { &["jq"] }
    fn grammar_name(&self) -> &'static str { "jq" }
    ...
    fn lang_key(&self) -> &'static str { "jq" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["jq"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".jq").unwrap_or(entry_name).to_string()
    }
