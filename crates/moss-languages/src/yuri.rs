...
impl Language for Yuri {
    fn name(&self) -> &'static str { "Yuri" }
    fn extensions(&self) -> &'static [&'static str] { &["yuri"] }
    fn grammar_name(&self) -> &'static str { "yuri" }
    ...
    fn lang_key(&self) -> &'static str { "yuri" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["yuri"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".yuri").unwrap_or(entry_name).to_string()
    }
