...
impl Language for Uiua {
    fn name(&self) -> &'static str { "Uiua" }
    fn extensions(&self) -> &'static [&'static str] { &["ua"] }
    fn grammar_name(&self) -> &'static str { "uiua" }
    ...
    fn lang_key(&self) -> &'static str { "uiua" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["ua"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".ua").unwrap_or(entry_name).to_string()
    }
