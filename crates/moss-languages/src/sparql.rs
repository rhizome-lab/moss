...
impl Language for Sparql {
    fn name(&self) -> &'static str { "SPARQL" }
    fn extensions(&self) -> &'static [&'static str] { &["sparql", "rq"] }
    fn grammar_name(&self) -> &'static str { "sparql" }
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["sparql", "rq"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "sparql" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["sparql", "rq"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".sparql")
