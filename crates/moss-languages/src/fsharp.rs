...
impl Language for FSharp {
    ...
    fn grammar_name(&self) -> &'static str { "fsharp" }
    ...
    fn scope_creating_kinds(&self) -> &'static [&'static str] {
        &["for_expression", "while_expression", "try_expression", "match_expression"]
    }

    fn control_flow_kinds(&self) -> &'static [&'static str] {
        &["if_expression", "match_expression", "for_expression", "while_expression",
          "try_expression", "application_expression"]
    }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] {
        &["if_expression", "match_expression", "for_expression", "while_expression",
          "try_expression", "function_or_value_defn", "module_defn"]
    }
    ...
    fn extract_function(&self, node: &Node, content: &str, _in_container: bool) -> Option<Symbol> {
        ...
        let kind = if is_member { SymbolKind::Method } else { SymbolKind::Function };
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if ext != "fs" && ext != "fsi" && ext != "fsx" { return None; }
    ...
    fn module_name_to_paths(&self, module: &str) -> Vec<String> {
        ...
        vec![
            format!("{}.fs", file_name),
            format!("src/{}.fs", file_name),
        ]
    }

    fn lang_key(&self) -> &'static str { "fsharp" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["fs"] }
