...
impl Language for Starlark {
    fn name(&self) -> &'static str { "Starlark" }
    fn extensions(&self) -> &'static [&'static str] { &["star", "bzl"] }
    fn grammar_name(&self) -> &'static str { "starlark" }
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["star", "bzl"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "starlark" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["star", "bzl"] }
