...
impl Language for Xml {
    ...
    fn extensions(&self) -> &'static [&'static str] { &["xml", "xsl", "xslt", "xsd", "svg", "plist"] }
    fn grammar_name(&self) -> &'static str { "xml" }

    fn has_symbols(&self) -> bool { false }

    fn container_kinds(&self) -> &'static [&'static str] { &["element"] }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] { &["element"] }
