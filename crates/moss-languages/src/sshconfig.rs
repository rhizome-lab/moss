...
impl Language for SshConfig {
    fn name(&self) -> &'static str { "SSH Config" }
    fn extensions(&self) -> &'static [&'static str] { &[] }  // Matched by filename
    fn grammar_name(&self) -> &'static str { "ssh-config" }
    ...
    fn lang_key(&self) -> &'static str { "ssh-config" }
