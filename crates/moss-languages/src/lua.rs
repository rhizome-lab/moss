...
impl Language for Lua {
    ...
    fn grammar_name(&self) -> &'static str { "lua" }
    ...
    fn extract_function(&self, node: &Node, content: &str, _in_container: bool) -> Option<Symbol> {
        ...
        Some(Symbol {
            ...
            visibility: if is_local { Visibility::Private } else { Visibility::Public },
            children: Vec::new(),
        })
    }
    ...
    fn module_name_to_paths(&self, module: &str) -> Vec<String> {
        ...
        vec![
            format!("{}.lua", path),
            format!("{}/init.lua", path),
        ]
    }

    fn lang_key(&self) -> &'static str { "lua" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["lua"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".lua").unwrap_or(entry_name).to_string()
    }
