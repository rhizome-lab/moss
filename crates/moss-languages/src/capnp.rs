...
impl Language for Capnp {
    fn name(&self) -> &'static str { "Cap'n Proto" }
    fn extensions(&self) -> &'static [&'static str] { &["capnp"] }
    fn grammar_name(&self) -> &'static str { "capnp" }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] { &["struct", "interface"] }
    ...
    fn lang_key(&self) -> &'static str { "capnp" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["capnp"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".capnp").unwrap_or(entry_name).to_string()
    }
