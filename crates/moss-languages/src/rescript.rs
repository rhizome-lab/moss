...
impl Language for ReScript {
    fn name(&self) -> &'static str { "ReScript" }
    fn extensions(&self) -> &'static [&'static str] { &["res", "resi"] }
    fn grammar_name(&self) -> &'static str { "rescript" }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] {
        &["if_expression", "switch_expression", "block", "module_declaration"]
    }
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["res", "resi"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "rescript" }

    fn is_stdlib_import(&self, import_name: &str, _project_root: &Path) -> bool {
        import_name.starts_with("Belt") || import_name.starts_with("Js.")
            || import_name == "Array" || import_name == "List" || import_name == "Option"
    }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["res", "resi"] }
