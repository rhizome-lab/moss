...
impl Language for ObjC {
    fn name(&self) -> &'static str { "Objective-C" }
    fn extensions(&self) -> &'static [&'static str] { &["m", "mm"] }
    fn grammar_name(&self) -> &'static str { "objc" }
    ...
    fn public_symbol_kinds(&self) -> &'static [&'static str] {
        &["class_interface", "protocol_declaration", "method_declaration"]
    }
    ...
    fn scope_creating_kinds(&self) -> &'static [&'static str] {
        &["class_implementation", "method_declaration", "function_definition", "compound_statement"]
    }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] {
        &["if_statement", "switch_statement", "while_statement", "for_statement", "compound_statement"]
    }
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["m", "mm"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "objc" }

    fn is_stdlib_import(&self, import_name: &str, _project_root: &Path) -> bool {
        import_name.starts_with("<Foundation/") || import_name.starts_with("<UIKit/")
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["m", "mm", "h"] }
