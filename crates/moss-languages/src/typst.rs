...
impl Language for Typst {
    fn name(&self) -> &'static str { "Typst" }
    fn extensions(&self) -> &'static [&'static str] { &["typ"] }
    fn grammar_name(&self) -> &'static str { "typst" }
    ...
    fn lang_key(&self) -> &'static str { "typst" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["typ"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".typ").unwrap_or(entry_name).to_string()
    }
