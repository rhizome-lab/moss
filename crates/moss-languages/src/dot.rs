...
impl Language for Dot {
    ...
    fn extensions(&self) -> &'static [&'static str] { &["dot", "gv"] }
    fn grammar_name(&self) -> &'static str { "dot" }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] { &["subgraph"] }
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["dot", "gv"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "dot" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["dot", "gv"] }
