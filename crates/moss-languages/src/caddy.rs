...
impl Language for Caddy {
    ...
    fn extensions(&self) -> &'static [&'static str] { &["caddyfile"] }
    fn grammar_name(&self) -> &'static str { "caddy" }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] { &["site_block", "directive_block"] }
    ...
    fn lang_key(&self) -> &'static str { "caddy" }
