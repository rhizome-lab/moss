...
impl Language for TlaPlus {
    fn name(&self) -> &'static str { "TLA+" }
    fn extensions(&self) -> &'static [&'static str] { &["tla"] }
    fn grammar_name(&self) -> &'static str { "tlaplus" }
    ...
    fn lang_key(&self) -> &'static str { "tlaplus" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["tla"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".tla").unwrap_or(entry_name).to_string()
    }
