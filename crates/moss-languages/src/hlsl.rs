...
impl Language for Hlsl {
    ...
    fn extensions(&self) -> &'static [&'static str] { &["hlsl", "hlsli", "fx", "fxh", "cginc"] }
    fn grammar_name(&self) -> &'static str { "hlsl" }

    fn has_symbols(&self) -> bool { true }

    fn container_kinds(&self) -> &'static [&'static str] {
        &["struct_specifier", "cbuffer_declaration"]
    }
    ...
    fn extract_container(&self, node: &Node, content: &str) -> Option<Symbol> {
        ...
        let kind = match node.kind() {
            "struct_specifier" => SymbolKind::Struct,
            "cbuffer_declaration" => SymbolKind::Module,
            _ => return None,
        };
    ...
    fn lang_key(&self) -> &'static str { "hlsl" }
...
mod tests {
    ...
    fn unused_node_kinds_audit() {
        ...
        let documented_unused: &[&str] = &[
            ...
            "call_expression", "cast_expression", "catch_clause", "cbuffer_specifier",
