...
impl Language for DeviceTree {
    fn name(&self) -> &'static str { "DeviceTree" }
    fn extensions(&self) -> &'static [&'static str] { &["dts", "dtsi"] }
    fn grammar_name(&self) -> &'static str { "devicetree" }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] { &["node"] }
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["dts", "dtsi"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "devicetree" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["dts", "dtsi"] }
