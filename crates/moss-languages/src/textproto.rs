...
impl Language for TextProto {
    fn name(&self) -> &'static str { "TextProto" }
    fn extensions(&self) -> &'static [&'static str] { &["textproto", "pbtxt"] }
    fn grammar_name(&self) -> &'static str { "textproto" }
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["textproto", "pbtxt"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "textproto" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["textproto", "pbtxt"] }
    ...
    fn package_module_name(&self, entry_name: &str) -> String {
        entry_name.strip_suffix(".textproto")
