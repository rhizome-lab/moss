...
impl Language for Diff {
    ...
    fn extensions(&self) -> &'static [&'static str] { &["diff", "patch"] }
    fn grammar_name(&self) -> &'static str { "diff" }
    ...
    fn nesting_nodes(&self) -> &'static [&'static str] { &["file_change"] }
    ...
    fn extract_container(&self, node: &Node, content: &str) -> Option<Symbol> {
        ...
        // Extract filename from diff header
        let name = first_line.split_whitespace()
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["diff", "patch"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "diff" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["diff", "patch"] }
