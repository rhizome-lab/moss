...
impl Language for PostScript {
    fn name(&self) -> &'static str { "PostScript" }
    fn extensions(&self) -> &'static [&'static str] { &["ps", "eps"] }
    fn grammar_name(&self) -> &'static str { "postscript" }
    ...
    fn file_path_to_module_name(&self, path: &Path) -> Option<String> {
        ...
        if !["ps", "eps"].contains(&ext) { return None; }
    ...
    fn lang_key(&self) -> &'static str { "postscript" }
    ...
    fn indexable_extensions(&self) -> &'static [&'static str] { &["ps", "eps"] }
